...
\begin{frame}{Nested Reasoning}
  ...
  \bigskip \pause
    ...
    \begin{itemize}
      \item $\color{RedOrange} \Kmc \models \dlFont{Human} \definc \exists \dlFont{worships}.\dlFont{Anthropomorphic}$ \pause
...
\color{red}Include comparisons between strengths.
